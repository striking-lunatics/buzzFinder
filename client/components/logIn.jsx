      ...
      return (
         <div>
            ...
            <form>
               ...
               <input className='input-large form-control' type="password" value={this.state.password} placeholder='Password...' onChange={(e) => this.setState({password: e.target.value})}/> {/*uN:{this.state.username}*/}
